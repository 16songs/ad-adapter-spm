...
/// Returns SDK state. You can check if SDK is initialized
...
///
- (void)getBidTokenWithParams:(MolocoParams * _Nonnull)params completion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion;
@end
...
/// \param params Pass initialization params
///
/// \param completion this block is called when SDK initialization completes.
///
- (void)initializeWithParams:(MolocoInitParams * _Nonnull)params completion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=13.0);
@end

@class MolocoCreateAdParams;
...
/// \param params MolocoCreateAdParams
///
///
/// returns:
/// returns <code>MolocoBannerAdView</code>ad  object with configured as MREC.
- (MolocoBannerAdView * _Nullable)createMRECWithParams:(MolocoCreateAdParams * _Nonnull)params viewController:(UIViewController * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
...
- (MolocoBannerAdView * _Nullable)createBannerWithParams:(MolocoCreateAdParams * _Nonnull)params viewController:(UIViewController * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
...
- (id <MolocoInterstitial> _Nullable)createInterstitialWithParams:(MolocoCreateAdParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
- (id <MolocoRewardedInterstitial> _Nullable)createRewardedWithParams:(MolocoCreateAdParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates a native ad
/// \param params MolocoCreateAdParams
///
///
...
- (id <MolocoNativeAd> _Nullable)createNativeAdWithParams:(MolocoCreateAdParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
@protocol MolocoAd <Destroyable, Readiable, NSObject>
...
@optional
/// Optional revenue (e.g., CPM in USD) if available.
/// Exposed as NSNumber? for Objective-C compatibility.
@property (nonatomic, readonly, strong) NSNumber * _Nullable revenue;
/// Optional creative identifier if available.
/// NSString for Objective-C compatibility.
@property (nonatomic, readonly, strong) NSString * _Nullable creativeId;
@end
...
@property (nonatomic, strong) NSString * _Nullable creativeId;
...
/// Use this object to get BidToken
SWIFT_CLASS("_TtC9MolocoSDK12MolocoParams")
@interface MolocoParams : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull mediationName;
- (nonnull instancetype)initWithMediation:(NSString * _Nonnull)mediationName OBJC_DESIGNATED_INITIALIZER;
...
@class NSData;
/// Use this object to create ad
SWIFT_CLASS("_TtC9MolocoSDK20MolocoCreateAdParams")
@interface MolocoCreateAdParams : MolocoParams
@property (nonatomic, readonly, copy) NSString * _Nonnull adUnit;
@property (nonatomic, readonly, copy) NSData * _Nullable watermarkData;
- (nonnull instancetype)initWithAdUnit:(NSString * _Nonnull)adUnit mediation:(NSString * _Nonnull)mediationName watermarkData:(NSData * _Nullable)watermarkData OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithAdUnit:(NSString * _Nonnull)adUnit mediation:(NSString * _Nonnull)mediation;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)initWithMediation:(NSString * _Nonnull)mediationName SWIFT_UNAVAILABLE;
@end
...
@interface MolocoInitParams : MolocoParams
@property (nonatomic, readonly, copy) NSString * _Nonnull appKey;
- (nonnull instancetype)initWithAppKey:(NSString * _Nonnull)appKey mediation:(NSString * _Nonnull)mediationName OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)initWithMediation:(NSString * _Nonnull)mediationName SWIFT_UNAVAILABLE;
@end
